...
# static fields
.field private static zza:Lcom/google/firebase/messaging/zza;
...
.field private zzd:Ljava/lang/reflect/Method;

.field private zze:Ljava/lang/reflect/Method;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzf:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
...
.method private final zza(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzd:Ljava/lang/reflect/Method;

    if-nez p1, :cond_6

    const-string p1, "setChannelId"

    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zza(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzd:Ljava/lang/reflect/Method;
...
.method private final zza()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzc:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzc:Landroid/os/Bundle;
...
.method static declared-synchronized zza(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/zza;->zza:Lcom/google/firebase/messaging/zza;
    ...
    sput-object v1, Lcom/google/firebase/messaging/zza;->zza:Lcom/google/firebase/messaging/zza;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/zza;->zza:Lcom/google/firebase/messaging/zza;
    :try_end_0
...
.method private static zza(Ljava/lang/String;)Ljava/lang/reflect/Method;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method static zzb(Landroid/os/Bundle;)Landroid/net/Uri;
    .locals 2
...
.method private final zzb(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 4
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zza()Landroid/os/Bundle;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
...
.method private final zzc(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zze:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/zza;->zze:Ljava/lang/reflect/Method;
    ...
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zze:Ljava/lang/reflect/Method;
    ...
    iget-object v8, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
...
.method static zzd(Landroid/os/Bundle;)Ljava/lang/String;
    .locals 2
...
.method private final zzd(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
...
.method private final zze(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    .locals 3
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzb(Landroid/os/Bundle;)Landroid/net/Uri;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zza(Landroid/os/Bundle;)V
    ...
    :cond_6
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;

    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzf:Ljava/util/concurrent/atomic/AtomicInteger;
...
# virtual methods
.method final zzc(Landroid/os/Bundle;)Z
    .locals 12
    ...
    iget-object v3, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Lcom/google/firebase/messaging/zza;->zza(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zza(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zza(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzb(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v7

    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzd(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;
    ...
    :goto_2
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zze(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v3

    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzb(Landroid/os/Bundle;)Z
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/zza;->zzf:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/zza;->zzb:Landroid/content/Context;

    iget-object v11, p0, Lcom/google/firebase/messaging/zza;->zzf:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzc(Ljava/lang/String;)Ljava/lang/String;
