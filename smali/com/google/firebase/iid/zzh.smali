...
.field private zze:Lcom/google/firebase/iid/zzf;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzd:Ljava/util/Queue;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzf:Z

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/iid/zzh;->zza:Landroid/content/Context;

    new-instance p1, Landroid/content/Intent;

    invoke-direct {p1, p2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iget-object p2, p0, Lcom/google/firebase/iid/zzh;->zza:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzh;->zzb:Landroid/content/Intent;

    iput-object p3, p0, Lcom/google/firebase/iid/zzh;->zzc:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private final declared-synchronized zza()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zzd:Ljava/util/Queue;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zze:Lcom/google/firebase/iid/zzf;
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zze:Lcom/google/firebase/iid/zzf;
    ...
    iget-boolean v2, p0, Lcom/google/firebase/iid/zzh;->zzf:Z
    ...
    :cond_4
    iget-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzf:Z

    if-nez v0, :cond_6

    iput-boolean v1, p0, Lcom/google/firebase/iid/zzh;->zzf:Z
    :try_end_0
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzh;->zza:Landroid/content/Context;

    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzb:Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/iid/zzd;->zza()V
    :try_end_3
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/iid/zzh;->zze:Lcom/google/firebase/iid/zzf;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/iid/zzh;->zza()V
...
.method public final declared-synchronized zza(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzc:Ljava/util/concurrent/ScheduledExecutorService;
